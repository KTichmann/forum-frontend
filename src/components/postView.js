            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ marginLeft: '25px' }}>
                    ...
                    <div style={{  margin: '10px', marginLeft: '12px', fontFamily: 'Ubuntu', fontSize: '16px', width: '800px', position: "relative" }}>
                        ...
                        <span id="delete-section" className="posts" style={{ right: "60px", bottom: "0px", position: "absolute", color: "rgba(17, 28, 121, 0.6)", cursor: "pointer", fontWeight: "600", display: props.userCanEdit ? "block" : "none" }} onClick={() => props.handleDelete ? props.handleDelete() : false}>{props.deleteText}</span>
                    </div>
                </div>
            </div>
        </div>
